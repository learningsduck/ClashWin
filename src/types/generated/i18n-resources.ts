...
export interface TranslationResources {
  translation: {
    "auth": {
      "login": {
        ...
        "messages": {
          ...
          "adminCredentialsRequired": string;
    ...
    "settings": {
      "account": {
        "active": string;
        "bindCodeSendFailed": string;
        "bindCodeSent": string;
        "bindEmail": string;
        "bindEmailRequired": string;
